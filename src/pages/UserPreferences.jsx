...
const UserPreferences = ({ listType, mediaTypes }) => {
    ...
    try {
      ...
      if (listType === "rated") {
        res = await submitMediaRating({
          mediaType,
          mediaId: mediaType === MEDIA_TYPES.EPISODES ? show_id : mediaId,
          sessionID,
          isEpisode: mediaType === MEDIA_TYPES.EPISODES,
  ...
  useEffect(() => {
    ...
    getMedia({ signal: abortController.signal });
    setMedia((prevMedia) => ({
      ...prevMedia,
      list: [],
      isLoading: true,
